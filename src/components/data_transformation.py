...
class DataTransformation:   
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            numerical_variable_pipeline = Pipeline(
                steps=[
            ...
            categorical_variable_pipeline = Pipeline(
                steps=[
                    ('imputer', SimpleImputer(strategy = 'most_frequent')),
                    ('one_hot_encoder', OneHotEncoder()),
                    ('scaler', StandardScaler(with_mean=False))  # always mention with_mean=False
                ]
            )
            ...
            preprocessor = ColumnTransformer(
                [
                    ('numerical_pipeline', numerical_variable_pipeline, numerical_columns),
                    ('categorical_pipeline', categorical_variable_pipeline, categorical_columns)
                ]
            )
